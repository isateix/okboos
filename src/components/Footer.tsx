...
const Footer = () => {
  const { t } = useLanguage(); // hook para tradução
  ...
  return (
    <footer className="bg-[#003D73] text-gray-300 text-sm pt-14 pb-8 mt-8">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10 px-6 md:px-12 border-b border-[#004a8f] pb-10">
        ...
        {/* Links úteis */}
        <div>
          <h2 className="font-semibold text-lg text-white mb-4">{t("company")}</h2>
          <ul className="text-base space-y-2">
            <li>
              <Link href="/" className="hover:text-[#0071BC] transition">
                {t("home")}
              </Link>
            </li>
            <li>
              <Link href="/contacto" className="hover:text-[#0071BC] transition">
                {t("contact")}
              </Link>
            </li>
            <li>
              <Link href="/politica-privacidade" className="hover:text-[#0071BC] transition">
                {t("privacyPolicy")}
              </Link>
            </li>
          </ul>
        ...
        <div>
          <h2 className="font-semibold text-lg text-white mb-4">{t("contactUs")}</h2>
      ...
      <p className="text-center text-xs mt-8 text-gray-400">
        2025 © <span className="text-[#0071BC] font-semibold">Okbooss</span>. {t("allRightsReserved")}
      </p>
    </footer>
  );
};
