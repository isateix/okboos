      ...
      <Link href={`/produtos/${product.id}`} className="block">
        <div className="relative bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition flex flex-col items-center text-center p-4">
          ...
          <div className="w-full sm:w-auto">
            <button className="bg-blue-600 text-white px-3 py-2 sm:px-4 sm:py-2 rounded-lg shadow-md hover:bg-blue-700 transition text-sm sm:text-base w-full sm:w-auto">
              Ver Mais Detalhes
            </button>
          </div>
        </div>
